...
JOURNAL_API = "https://cepmobtoken.eu.prod.c3.volvocars.com/journallog-trip-api/vehicles/{0}/trips?quantity=0"
...
supported_entities = [
                        ...
                        {"name": "Trips", "domain": "sensor", "id": "trips", "icon": "alert", "url": JOURNAL_API}
]
